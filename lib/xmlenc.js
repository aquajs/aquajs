/* NPM install update the latest xmlencryption paackage
 It doesn't have  decryptSAML function.
 We need to manually copy paste decryptSAML function and include in the exports section as in the file.
 */
...
function decryptSAML(xml, options) {
    ...
    switch (encryptionAlgorithm) {
        case 'http://www.w3.org/2001/04/xmlenc#aes256-cbc':
            ...
            decrypted = decipher.update(encrypted.slice(16), 'binary') + decipher.final('binary');
            break;
        default:
