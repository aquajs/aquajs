...
devErrors = function (err, req, res, next) {
  if(err.errors){
      console.log("Error occurred in the service with error : " + err.errors && JSON.stringify(err.errors));
    ...
    console.log("Error occurred in the service with error : " + err.message && JSON.stringify(err.message));
