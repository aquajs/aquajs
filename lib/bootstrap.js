    ...
    app.get(/^\/apidocSample(\/.*)?$/, function (req, res, next) {
      if (req.url === '/apidocSample') {
        ...
        if(sampleData) {
            ...
            res.write("</br>Sample object for POST:<pre>" + JSON.stringify(sampleData.samplePut, null, 2));
            }
            if(sampleData.samplePatch) {
            res.write("</br>Sample object for POST:<pre>" + JSON.stringify(sampleData.samplePatch, null, 2));
            }
            if(sampleData.sampleDelete) {
            res.write("</br>Sample object for POST:<pre>" + JSON.stringify(sampleData.sampleDelete, null, 2));
            }
        }
