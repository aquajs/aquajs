      ...
      if (req.url === '/apidocSample') {
        ...
        if(sampleData) {
          if(sampleData.sampleGet) {
            res.write("</br>Sample object for POST:<pre>" + JSON.stringify(sampleData.sampleGet, null, 2));
          }
          ...
          if(sampleData.samplePut) {
            res.write("</br>Sample object for Put:<pre>" + JSON.stringify(sampleData.samplePut, null, 2));
          }
          if(sampleData.samplePatch) {
            res.write("</br>Sample object for Patch:<pre>" + JSON.stringify(sampleData.samplePatch, null, 2));
          }
          if(sampleData.sampleDelete) {
            res.write("</br>Sample object for Delete:<pre>" + JSON.stringify(sampleData.sampleDelete, null, 2));
          }
        }
        res.write("</pre>");
        res.end();
